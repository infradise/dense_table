      ...
      child: Row(
        children: List.generate(headers.length, (index) =>
          Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                right: BorderSide(color: style.borderColor), // Vertical separator
              ),
            ),
...
class DenseStyle {
  ...
  const DenseStyle({
    ...
    this.altBackgroundColor = const Color(0xFF2B2D30), // Zebra stripe background
